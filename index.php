...
<html lang="en">
  <head>
    <title>Kisindi primary web</title>
    <meta charset="utf-8">
    	...
    	<div class="container">
    		<div class="row d-flex align-items-center">
    			...
    			<div class="col d-flex justify-content-end">
    				<p class="num"><span class="icon-phone"></span> +254 798013452</p>
    			</div>
    		</div>
    	</div>
    </div>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="teachers.php" class="nav-link">About Teachers</a></li>
