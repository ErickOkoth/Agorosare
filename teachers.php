    		...
    		<div class="row">
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							...
							<div class="text pt-4">
								<h3><a href="#">Mr Olima</a></h3>
								<span class="position mb-2">4 Listing</span>
								<p>I am a teacher by profession and a simple guy.</p>
