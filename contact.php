    	...
    	<div class="container">
    		<div class="row d-flex align-items-center">
    			...
    			<div class="col d-flex justify-content-end">
    				<p class="num"><span class="icon-phone"></span> +254 0798013452</p>
    			</div>
    		</div>
    	</div>
    </div>
        ...
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Address:</span> 198 Nyangwete west ward, Homa Bay ,Kenya</p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Phone:</span> <a href="tel://0798013452">+254 798013452</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
